namespace Magva.Infra.Crosscutting.Constants
{
    public static class ExceptionConstants
    {
        public static string INSUFFICIENT_BALANCE = "INSUFFICIENT_BALANCE";
        public static string ERROR_IN_PASSWORD_SIZE = "ERROR_IN_PASSWORD_SIZE";
        public static string CARD_BLOCKED = "CARD_BLOCKED";
